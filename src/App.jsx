    ...
    <>
      <PostHogCaptureOnViewed name="hero_section_viewed" properties={{ section: "hero" }}>
        <section className="hero">
          ...
          <div className="pill">The Exchange — a renter-first marketplace</div>
          <h1>
            Stop endlessly
            <span className="rotating-line"><RotatingWord />.</span>
            <span className="accent">Be the verified renter every landlord wants to find.</span>
          </h1>
          <p className="lead">
            Verified once on VryfID. Discovered everywhere on The Exchange.
            First 1,000 renters get verified free at launch.
          </p>
      ...
      <ScrollReveal>
        <section className="section section--problem">
          ...
          <h2 className="section-title">Renting today is a tax on your time, money, and dignity.</h2>
      ...
      <ScrollReveal>
        <section className="shift-section">
          ...
          <h2 className="shift-title">
            The Exchange flips it: landlords receive verified, qualified renters first —
            then connect with the ones who actually fit.
          </h2>
        </section>
      </ScrollReveal>
        ...
        <div className="cta-wrapper">
          <section className="cta-section">
            <h2 className="cta-title">
              ...
              <span className="accent"> Apartments come to you. You approve the best ones.</span>
            </h2>
            <p className="cta-sub">
      ...
      <ScrollReveal>
        <section className="founders">
          ...
          <div className="founders-copy">
            ...
            <p>
              We&apos;re brothers, and we&apos;re building VryfID and The Exchange so renters can get verified once,
              actually be matched on fit, and stop starting from zero every time they want a real shot at a home.
            </p>
          </div>
    ...
    <>
          ...
          <div className="dashboard-layout">
            <div>
              ...
              <ul className="check-list">
                <li><span className="check">✓</span>Auto-verify identity, income, and rental history in minutes.</li>
                <li><span className="check">✓</span>Flag synthetic IDs, edited documents, and income inconsistencies.</li>
                <li><span className="check">✓</span>See fit at a glance — budget, move-in date, household size, lease length.</li>
                <li><span className="check">✓</span>Send, track, and close applications without a chain of emails.</li>
                <li><span className="check">✓</span>Stay compliant — audit trail and consent baked in.</li>
              </ul>
            </div>
            <DashboardMock />
          </div>
      ...
      <ScrollReveal>
        <section className="section section--solution">
          ...
          <p className="section-lead">
            Operators on VryfID get direct access to The Exchange — a marketplace of renters who&apos;ve
            already been verified, with budgets and timing that match your open units. Less hunting, more leasing.
          </p>
          <div className="solution-cards">
            <FeatureCard
              icon="🛡"
      ...
      <ScrollReveal>
        <div className="cta-wrapper">
          <section className="cta-section">
            <h2 className="cta-title">
              Stop running a leasing funnel on email and PDFs.
              <span className="accent"> Run it on VryfID.</span>
            </h2>
